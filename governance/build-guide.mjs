...
/* ── Copy-code button (injected on every <pre>) ───────────────────── */
...
.copy-btn:focus-visible { opacity: 1; outline: 2px solid var(--primary); outline-offset: 1px; }
.copy-btn:hover {
  color: var(--fg);
  background: var(--muted);
}
...
(function () {
  ...
  // Copy-code buttons — inject into every <pre><code> block
