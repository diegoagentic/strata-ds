...
const badgeVariants = cva(
  "inline-flex items-center justify-center rounded-full border px-2.5 py-0.5 text-xs font-semibold w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1.5 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden",
  {
    ...
    compoundVariants: [
      ...
      { variant: "solid", color: "red", class: "bg-error text-white hover:bg-error" },
      { variant: "solid", color: "orange", class: "bg-orange-600 text-white hover:bg-orange-700" },
      { variant: "solid", color: "amber", class: "bg-warning-light0 text-white hover:bg-warning" },
      ...
      { variant: "solid", color: "green", class: "bg-success text-white hover:bg-success" },
      { variant: "solid", color: "emerald", class: "bg-success text-white hover:bg-success" },
      ...
      { variant: "solid", color: "blue", class: "bg-info text-white hover:bg-info" },
      ...
      { variant: "soft", color: "red", class: "bg-error-light text-error dark:bg-error/10/50 dark:text-error hover:bg-error-light dark:hover:bg-error/10/70" },
      ...
      { variant: "soft", color: "amber", class: "bg-warning-light text-warning dark:bg-warning/10/50 dark:text-warning hover:bg-warning-light dark:hover:bg-warning/10/70" },
      ...
      { variant: "soft", color: "green", class: "bg-success-light text-success dark:bg-success/20 dark:text-success hover:bg-green-100 dark:hover:bg-success/30" },
      { variant: "soft", color: "emerald", class: "bg-success-light text-success dark:bg-success/20 dark:text-success hover:bg-success-light dark:hover:bg-success/30" },
      ...
      { variant: "soft", color: "blue", class: "bg-info-light text-info dark:bg-info/10/50 dark:text-info hover:bg-info-light dark:hover:bg-info/10/70" },
      ...
      { variant: "outline", color: "red", class: "text-error dark:text-error border-error/20 dark:border-error/30" },
      { variant: "outline", color: "orange", class: "text-orange-700 dark:text-orange-400 border-orange-200 dark:border-orange-900" },
      { variant: "outline", color: "amber", class: "text-warning dark:text-warning border-warning/20 dark:border-warning/30" },
      ...
      { variant: "outline", color: "green", class: "text-success dark:text-success border-success/20 dark:border-success/30" },
      { variant: "outline", color: "emerald", class: "text-success dark:text-success border-success/20 dark:border-success/30" },
      ...
      { variant: "outline", color: "blue", class: "text-info dark:text-info border-info/20 dark:border-info/30" },
