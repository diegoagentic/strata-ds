  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-zinc-900 dark:focus-visible:border-zinc-300 focus-visible:ring-zinc-900/20 dark:focus-visible:ring-zinc-300/20 focus-visible:ring-[3px]",
