        ...
        <div className="space-y-8">
            ...
            <div>
                ...
                <div className="flex flex-wrap items-center gap-4 p-6 bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-white/10">
                    <span className="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium bg-success-light text-success ring-1 ring-inset ring-success/20">
                        Shipped
                    </span>
                    <span className="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium bg-info-light text-info ring-1 ring-inset ring-info/20">
                        In Production
                    </span>
                    ...
                    <span className="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium bg-error-light text-error ring-1 ring-inset ring-error/10">
                        Overdue
                    </span>
                </div>
            ...
            <div>
                ...
                <div className="flex items-center gap-8 p-6 bg-zinc-50 dark:bg-black/20 rounded-xl border border-zinc-200 dark:border-white/10">
                    <div className="relative inline-block">
                        ...
                        <span className="absolute -top-2 -right-2 inline-flex items-center justify-center min-w-[20px] h-5 px-1.5 text-xs font-bold text-white bg-error rounded-full border-2 border-white dark:border-zinc-900">
                            3
                        </span>
                    </div>
                </div>
