export const tokens = {
  'color-background': '#F4F4F1',
  'color-foreground': '#0B0B0C',
  'color-card': '#F4F4F1',
  'color-card-foreground': '#0B0B0C',
  'color-popover': '#F4F4F1',
  'color-popover-foreground': '#0B0B0C',
  'color-primary': '#d6ff3c',
  ...
  'color-sidebar': '#F4F4F1',
  'color-sidebar-foreground': '#0B0B0C',
  'color-sidebar-primary': '#d6ff3c',
  'color-sidebar-primary-foreground': '#0B0B0C',
  'color-sidebar-accent': '#f4f4f5',
  'color-sidebar-accent-foreground': '#18181b',
  'color-sidebar-border': '#e4e4e7',
  'color-sidebar-ring': '#71717a',
  'color-brand-50': '#fdfee7',
  'color-brand-100': '#faffc2',
  'color-brand-200': '#f5ff92',
  'color-brand-300': '#edff58',
  'color-brand-400': '#d6ff3c',
  'color-brand-500': '#b4eb00',
  'color-brand-600': '#8bc200',
  'color-brand-700': '#679600',
  'color-brand-800': '#507206',
  'color-brand-900': '#425e0b',
  'color-brand-950': '#233502',
  'color-brand-lime': '#d6ff3c',
  'color-mono-offBlack': '#0B0B0C',
  'color-mono-deepGraphite': '#1E1E22',
  'color-mono-softGray': '#C8C8C8',
  'color-mono-offWhite': '#F4F4F1',
