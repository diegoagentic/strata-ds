    ...
    return (
        ...
        >
            <span className="flex items-center gap-3">
                <ChevronRight className="size-4 text-muted-foreground group-data-[open]:rotate-90 group-data-[hover]:text-zinc-700 dark:text-muted-foreground dark:group-data-[hover]:text-zinc-300 transition-transform duration-200" />
                {children}
            </span>
        </HeadlessDisclosureButton>
    )
